...
const navItemClass = (active: boolean, clickable: boolean) =>
  cn(
    ...
    active
      ? "font-bold text-accent bg-surface-active"
          ...
          <div ref={moreRef}>
            ...
            {moreOpen && (
              <button
                ...
                className={cn(
                  navItemClass(false, true),
                  "w-full text-left border-0 bg-transparent pl-9",
                )}
              >
                <span>🥚</span>
