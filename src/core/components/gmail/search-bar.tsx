...
export function SearchBar() {
  return (
    <header className="h-[var(--header-height)] flex items-center px-2 gap-2 border-b border-border-faint bg-surface shrink-0">
      ...
      <div className="flex-1 max-w-[720px] h-12 rounded-3xl bg-[var(--bg-tertiary)] hover:bg-[var(--bg-hover)] flex items-center px-4 gap-3 shadow-sm transition-colors">
        <svg
          aria-hidden="true"
          width="20"
          height="20"
        ...
        <span className="text-foreground/60 text-base">Search in mail</span>
      </div>
