...
export function getEmailMdxComponents(): MdxComponentsMap {
  return {
    ...
    ul: (props: HTMLAttributes<HTMLUListElement>) => <ul style={{ fontSize: 16 }} {...props} />,
    ol: (props: HTMLAttributes<HTMLOListElement>) => <ol style={{ fontSize: 16 }} {...props} />,
    ...
    code: (props: HTMLAttributes<HTMLElement> & PropsWithChildren) => (
      <CodeInline style={{ padding: '2px 6px', fontSize: '0.85em', backgroundColor: '#f0f0f0', borderRadius: 4, fontFamily: 'monospace' }}>
        {props.children}
      </CodeInline>
    ),
    pre: (props: { children?: JSX.Element }) => {
      ...
      return <CodeBlock code={codeContent} language={language as PrismLanguage} />
    },
    table: EmailTable,
