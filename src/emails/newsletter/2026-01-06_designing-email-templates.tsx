  ...
  return (
    ...
    >
      <Text style={{ color: "#0a0a0a", fontSize: 16, lineHeight: 1.6 }}>
        Email HTML is notoriously painful — inline styles, table layouts, and quirks across dozens of clients.
        React Email abstracts all of that away with a set of battle-tested components.
      </Text>
      <Text style={{ color: "#0a0a0a", fontSize: 16, lineHeight: 1.6 }}>
...
export default function NewsletterEmail() {
  return (
    <Html>
      ...
      <Text style={{ color: "#0a0a0a", fontSize: 16, lineHeight: 1.6 }}>
        The <strong>render()</strong> function from <strong>@react-email/render</strong> converts this JSX into
        email-safe HTML with all the right inline styles. Preview your templates locally with{" "}
        <strong>npx email dev</strong> before sending them to real inboxes. Next up: actually sending these
        emails with the Resend API.
      </Text>
    </NewsletterEmailLoader>
  )
}
