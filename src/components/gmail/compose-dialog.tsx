      ...
      <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          <div style={{ fontSize: 11, color: "var(--text-secondary)" }}>
            <span>Web </span>
            <a href="https://cesalberca.com" style={{ color: "var(--text-link)", textDecoration: "none" }}>
              cesalberca.com
            </a>
            <span> Email </span>
            <a href="mailto:cesar@cesalberca.com" style={{ color: "var(--text-link)", textDecoration: "none" }}>
          ...
          <div style={{ display: "flex", gap: 6, marginTop: 4 }}>
            {/* LinkedIn */}
            <a href="https://linkedin.com/in/cesalberca" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="#0a66c2">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              </svg>
            </a>
            {/* X / Twitter */}
            <a href="https://x.com/cesalberca" target="_blank" rel="noopener noreferrer" aria-label="X">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="var(--text-primary)">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>
            {/* Instagram */}
            <a href="https://instagram.com/cesalberca" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
...
function FormattingToolbar() {
  ...
  return (
    ...
    >
      <button style={iconStyle} aria-label="Undo">
      ...
      <button style={iconStyle} aria-label="Redo">
      ...
      <div style={{ width: 1, height: 18, backgroundColor: "var(--border-secondary)", margin: "0 4px" }} />
      <span style={{ fontSize: 12, color: "var(--text-secondary)", padding: "0 6px", cursor: "default" }}>
        Sans Serif
      </span>
      <div style={{ width: 1, height: 18, backgroundColor: "var(--border-secondary)", margin: "0 4px" }} />
      <button style={iconStyle} aria-label="Bold">
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          <button style={headerIconStyle} aria-label="Minimize">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M6 19h12v2H6z" /></svg>
          </button>
          <button style={headerIconStyle} aria-label="Pop out">
          ...
          <button onClick={close} style={headerIconStyle} aria-label="Close">
      ...
      >
        <span style={{ color: "var(--text-secondary)", marginRight: 8 }}>To</span>
        <span style={{ flex: 1, fontWeight: 400 }}>All subscribers</span>
        <span style={{ color: "var(--text-secondary)", fontSize: 12, display: "flex", gap: 8, alignItems: "center" }}>
          Cc Bcc
      ...
      >
        <span style={{ color: "var(--text-secondary)", marginRight: 8 }}>Subject</span>
        <select
          value={selectedIndex}
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "stretch" }}>
          <button
            ...
            style={{
              padding: "8px 20px",
              backgroundColor: status === "success" ? "var(--green)" : "#1a73e8",
              color: "#fff",
              border: "none",
          ...
          <button
            style={{
              padding: "8px 8px",
              backgroundColor: status === "success" ? "var(--green)" : "#1565c0",
              color: "#fff",
              border: "none",
        ...
        {/* Action icons */}
        <div style={{ display: "flex", alignItems: "center", marginLeft: 8, gap: 0 }}>
          <button style={bottomIconStyle} aria-label="Formatting options">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M5 17v2h14v-2H5zm4.5-4.2h5l.9 2.2h2.1L12.75 4h-1.5L6.5 15h2.1l.9-2.2zM12 5.98L13.87 11h-3.74L12 5.98z" /></svg>
          </button>
          <button style={bottomIconStyle} aria-label="Attach files">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.5 6v11.5c0 2.21-1.79 4-4 4s-4-1.79-4-4V5a2.5 2.5 0 015 0v10.5c0 .55-.45 1-1 1s-1-.45-1-1V6H10v9.5a2.5 2.5 0 005 0V5c0-2.21-1.79-4-4-4S7 2.79 7 5v12.5c0 3.04 2.46 5.5 5.5 5.5s5.5-2.46 5.5-5.5V6h-1.5z" /></svg>
          </button>
          <button style={bottomIconStyle} aria-label="Insert link">
          ...
          <button style={bottomIconStyle} aria-label="Insert emoji">
          ...
          <button style={bottomIconStyle} aria-label="Insert photo">
          ...
          <button style={bottomIconStyle} aria-label="More options">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M6 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm12 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-6 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" /></svg>
          </button>
        </div>

        {/* Delete (far right) */}
        <div style={{ marginLeft: "auto" }}>
          <button style={bottomIconStyle} aria-label="Discard draft" onClick={close}>
