...
export const sections: Section[] = [
  ...
  },
  {
    ...
    preview: "I have completed the architectural analysis of your newsletter system...",
    date: "Oct 15",
    unread: true,
    starred: false,
    folder: "inbox",
  },
  {
    ...
    preview: "Your rendering diagnostics are complete. We found several compatibility...",
    date: "Oct 15",
    unread: true,
    starred: false,
    folder: "inbox",
  },
  {
    ...
    preview: "Our automated scan has detected multiple layout violations in your...",
    date: "Oct 15",
    unread: true,
    starred: false,
    folder: "inbox",
  },
  {
    ...
    preview: "newsletter-pipeline (main) - All jobs passed. Build, preview, send...",
    date: "Oct 15",
    unread: false,
    starred: false,
    folder: "inbox",
  },
  {
    ...
    preview: "Our analysis has revealed critical issues that may cause total system...",
    date: "Oct 15",
    unread: true,
    starred: true,
    folder: "inbox",
